export async function onRequest(context) {
  ...
  if (env.IMGBB_API_KEY) {
    ...
    try {
      ...
      if (!imgRes.ok) {
        throw new Error(`ImgBB API error: ${imgRes.status} ${imgRes.statusText}`);
      }
